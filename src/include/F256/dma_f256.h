...
#define DMA_16BIT_EN        0x40    // Enable 16-bit wide transfers (F256*X only)
...
#define DMA_SRC_ADDR		((volatile __attribute__((far24)) uint8_t **)0xf01f04)
#define DMA_DST_ADDR		((volatile __attribute__((far24)) uint8_t **)0xf01f08)
#define DMA_SIZE			((volatile __attribute__((far)) uint32_t *)0xf01f0c)
